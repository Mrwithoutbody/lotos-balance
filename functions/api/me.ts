// functions/api/me.ts
// GET /api/me — kim jest zalogowana osoba dla aplikacji: imię, rola i talie,
// którymi zarządza. Bez sesji zwraca null, więc front nie musi łapać 401.
import { drizzle } from 'drizzle-orm/d1'
import { eq } from 'drizzle-orm'
import { getSession, pagesFunction } from '../../src/server/auth'
import { creators, user } from '../../src/server/db/schema'
